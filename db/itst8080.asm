...
temp0:  defb     1      !temporary storage for cpu test memory locations
temp1:  defb     1      !temporary storage for cpu test memory locations
temp2:  defb     1      !temporary storage for cpu test memory locations
temp3:  defb     1      !temporary storage for cpu test memory locations
temp4:  defb     1      !temporary storage for cpu test memory locations
savstk: defw     0      !temporary stack-pointer storage location

        defps    256    !de-bug stack pointer storage area
stack:             
