...
notes.txt    - Gives notes on this particular assembler, usually indicating bugs
               found.
i80586.txt   - Documentation on the assembler. Note that this is obsolete, and
               has been replaced by the IP manual entry for the assembler.
seg.txt      - Notes on using the flat address as80586 for segmentation in 
               i8086/i8088, i80186/i80188 16 bit modes. Note this contains 
               largely unimplemented assembly constructs. It was just a plan,
               there was never much demand for the 16 bit mode of as80586.
